Scriptname DAT_TestTriggerScript extends ObjectReference  
...
function TriggerMe()
	if disableWhenDone
		...
		testStartupKeyword.sendStoryEvent(akRef1 = DragonRef)
		Disable()
	endif
endFunction
...
keyword property testStartupKeyword Auto
ObjectReference property DragonRef auto